...
export default function Quiz() {
  ...
  // Find default fallback lesson if route parameter is missing
  const defaultLessonId = categories[0]?.lessons[0]?.id;
  const targetLessonId = paramLessonId || defaultLessonId;
